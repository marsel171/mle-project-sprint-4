...
print(f"Полученные идентификаторы рекомендаций: {recs}")
...
url = "http://127.0.0.1:8000/get_user_events"
headers = {"Content-type": "application/json", "Accept": "text/plain"}
...
url = "http://127.0.0.1:8000/put_user_event"
headers = {"Content-type": "application/json", "Accept": "text/plain"}
...
url = "http://127.0.0.1:8000/get_online_u2i"
headers = {"Content-type": "application/json", "Accept": "text/plain"}
